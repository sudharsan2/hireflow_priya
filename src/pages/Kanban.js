              ...
              {(provided, snapshot) => (
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ fontSize: "0.8em", color: "rgb(110,110,110)", marginLeft: '80%', marginBottom: '-2%', backgroundColor: 'rgb(210,210,210)', paddingRight: '10px', paddingLeft: '10px', borderRadius: '5px' }}>{tasks[column].length}</div>
                  </div>
                  <ul>
